    ...
    >
      ...
      >
        <div class="grid sm:grid-cols-2 gap-6 grid-cols-1 max-h-[70vh] overflow-y-auto">
          <div>
            <a-form-model-item ref="fullName" label="Tên người nhận" prop="fullName">
              <a-input
            ...
            <a-form-model-item ref="phoneNumber" label="Số điện thoại nhận hàng" prop="phoneNumber">
              <a-input
            ...
            <a-form-model-item label="Địa chỉ nhận hàng" prop="deliveryAddress">
          ...
          <div class="flex justify-between mt-4">
            ...
            <div class="text-black font-medium flex flex-col items-end space-y-7 pr-4 text-[1rem]">
              <p>  {{ totalCart.numberProduct }} Sản phẩm</p>
              <p>
                {{ totalCart.total }} VNĐ
              </p>
              <p>
  ...
  data () {
    return {
      ...
      rules: {
        ...
        deliveryAddress: [{ required: true, message: 'Trường phải điền', trigger: 'blur' }],
        phoneNumber: [{
          required: true,
          trigger: 'blur',
          min: 9,
  ...
  methods: {
    ...
    async submitOrder () {
      try {
        ...
        this.$toast.success('Đơn hàng thành công', { timeout: 1500 })
