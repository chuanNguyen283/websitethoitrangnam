...
export default {
  ...
  data () {
    return {
      addToCartLabel: 'Giỏ Hàng',
      viewDetailsLabel: 'Details',
      removeFromCartLabel: 'Xóa khỏi giỏ hàng',
      addToFavouriteLabel: 'Yêu Thích',
      removeFromFavouriteLabel: 'Xóa khỏi yêu thích',
      selected: 1,
      quickView: 'Xem Nhanh',
      listCarts: []
      // quantityArray: []
    ...
    async addToCart (productId) {
      if (this.isUserLogged) {
        try {
          ...
          this.$toast.success('Thêm thành công vào giỏ hàng!', { timeout: 1500 })
